...
uses
  DUnitTestRunner,
  DataSet.Serialize.Config in 'Vendor\DatasetSerialize\src\DataSet.Serialize.Config.pas',
  DataSet.Serialize.Consts in 'Vendor\DatasetSerialize\src\DataSet.Serialize.Consts.pas',
  DataSet.Serialize.Export in 'Vendor\DatasetSerialize\src\DataSet.Serialize.Export.pas',
  DataSet.Serialize.Import in 'Vendor\DatasetSerialize\src\DataSet.Serialize.Import.pas',
  DataSet.Serialize.Language in 'Vendor\DatasetSerialize\src\DataSet.Serialize.Language.pas',
  DataSet.Serialize in 'Vendor\DatasetSerialize\src\DataSet.Serialize.pas',
  DataSet.Serialize.UpdatedStatus in 'Vendor\DatasetSerialize\src\DataSet.Serialize.UpdatedStatus.pas',
  DataSet.Serialize.Utils in 'Vendor\DatasetSerialize\src\DataSet.Serialize.Utils.pas',
